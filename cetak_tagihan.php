...
<div class="card">
    ...
    <div class="card-body">
      <a style="margin-bottom: 20px" href="" target="_blank" class="btn btn-outline-primary btn-xs"><i style="margin-right=20px "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
