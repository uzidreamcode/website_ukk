            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown"> 
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="menu-icon fa fa-tasks"></i>Data Pembayaran</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-fire"></i><a href="admin.php?halaman=pembayaran">Pembayaran</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img style="max-width: 45px" src="images/logo.png" alt="Logo"></a>
