...
<div class="card">
	...
	<div class="card-body">
		...
		//tahun pelajaran mestinya bersifat dinamis, temukan cara agar th_pelajaran dapat ditentukan saat menampilkan kelas
			$sql = mysqli_query($koneksi,"SELECT kelas.kelas, kelas.th_pelajaran, count(kelas.nis) as jml, siswa.idjurusan FROM kelas,siswa WHERE kelas.nis=siswa.nis AND th_pelajaran='2021/2022' GROUP BY kelas.kelas");
			echo '<div class="row">';
