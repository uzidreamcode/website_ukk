...
<div class="container">   
  <div class="invoice-container" ref="document" id="html">
     ...
     <table style="width:100%; height:auto; background-color:#fff; margin-top:0px;  padding:20px; font-size:12px; border: 1px solid #ebebeb; border-top:0px;">
       ...
       <tbody>
         <tr>
           <td style="width:20%;margin-left:10px;text-align: center;">1</td>
           <td style="width:20%;margin-left:10px;text-align: center;"><?php echo $_GET['kls']?></td>
           <td style="width:20%;padding: 10px; text-align:center;"><?php echo $_GET['bln']?></td>
           <td style="width:20%;padding: 10px;text-align: center;">Rp <?php echo $_GET['jml']?></td>
     ...
     <table style="width:100%; height:auto; background-color:#fff;padding:20px; font-size:12px; border: 1px solid #ebebeb; border-top:0">
       <tbody>
         <tr style="padding:20px;color:#000;font-size:15px">
           ...
           <td style="text-align:right;padding:5px 0px;font-weight: bold;font-size:16px;">Rp <?php echo $_GET['jml']?></td>
         </tr>
